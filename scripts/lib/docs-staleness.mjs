export const DOC_RULES = Object.freeze([
  ...
  { id: "runtime-contracts", source: /^scripts\/lib\/(a2ui-store|checklist-workflow|doctor|docs-staleness|frontmatter-order|git-release-audit|harness-adapter|mobile-node-intake|model-router|pairing-store|plugin-eval|sandbox-runner|skill-validator|ssrf-guard|verification-gap|voice-gate|workspace-store)\.mjs$/, docs: ["README.md"] },
